    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h5 class="modal-title"><b>Tambah Jurusan Mahasiswa</b></h5>
            </div>
...
<div class="modal fade" id="addAdmin_modal" tabindex="-1" role="dialog" aria-labelledby="addAdmin_modal" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('admin/manageData/add_admin') ?>" method="post">
                    <div class="form-group">
                        ...
                        <input id="username" class="form-control here" name="username" type="text" placeholder="Masukkan Username" required>
                    </div>
                    <div style="float: right;">
                        <a class="btn btn-secondary" data-dismiss="modal">Cancel</a>
                        <button class="btn btn-primary" type="submit">Tambah Data</button>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h5 class="modal-title"><b>Tambah Divisi</b></h5>
            </div>
            <div class="modal-body">
                <form action="<?= base_url('admin/manageData/add_divisi') ?>" method="post">
                    <div class="form-group">
                        <label for="divisi">Divisi</label>
                        <input id="divisi" class="form-control here" name="divisi" type="text" placeholder="Masukkan Divisi" required>
                    </div>
                    <div style="float: right;">
                        <a class="btn btn-secondary" data-dismiss="modal">Cancel</a>
                        <button class="btn btn-primary" type="submit">Tambah Data</button>
