...
{ ?>
    <div style="padding-top: 20px; padding-right: 80px; float: right">
        ...
        <button style="float: right; margin-right: 5px" onclick="Export2Doc('isi_data','SL-<?= date("Y") ?>.SuratKeteranganSelesaiMagang.<?= $a['nim']?>.<?= $a['nama_mhs']?>')" class="btn btn-primary">Download as Word</button>
            ...
            <table>
                ...
                <tr>
                    <td style="text-align: justify">
                        Sehubungan dengan pelaksanaan Magang/Praktek Kerja Lapangan di PT PLN (Persero) Kantor Pusat, atas nama :
                    </td>
                </tr>
                <tr>
                    <td>&emsp;</td>
                ...
                <tr>
                    <td style="text-align: justify">
                        dengan ini kami sampaikan bahwa mahasiswa yang bersangkutan telah menyelesaikan magang di PT PLN (Persero) Kantor Pusat.
                    </td>
                </tr>
                <tr>
                    <td>&emsp;</td>
