...
<main id="main">
        ...
        <div class="container">
            <div class="section-header">
                <div style="z-index: 10;position: absolute; width: 96%">
                    <a class="nav-link" data-toggle="modal" data-target="#addServis_modal" href="" style="float: right">
                        <button style="background-color: rgba(0,0,0,.5); border-radius: 50%" class="btn btn-default">
                            <i class="fas fa-plus-circle" style="color: white;"></i>
                        </button>
                    </a>
                    <a class="nav-link" href="<?= base_url('admin/homeAdmin/edit_service') ?>" style="float: right; padding-right: 0.1px">
                        <button style="background-color: rgba(0,0,0,.5); border-radius: 50%" class="btn btn-default">
                            <i class="fas fa-edit" style="color: white"></i>
                        </button>
                    </a>
    ...
    <section id="contact" class="wow fadeInUp">
        <div class="container">
            <div class="section-header">
                <div style="z-index: 10;position: absolute; width: 96%">
                    <a class="nav-link" href="<?= base_url('admin/homeAdmin/edit_intro') ?>" style="float: right; margin-right: 10px">
                        <button style="background-color: rgba(0,0,0,.5); border-radius: 50%" class="btn btn-default">
                            <i class="fas fa-edit" style="color: white"></i>
                        </button>
                    </a>
