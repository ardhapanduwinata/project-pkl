    ...
    <div style="padding-top: 20px; padding-left: 80px">
        <table>
            <tr>
                ...
                <td>
                    <a href="<?= base_url('admin/manageData/view_sk_tolak') ?>">
    ...
    <div id="isi_data" style="padding-top: 100px;">
        ...
        <div style="margin-left: 80px; margin-right: 80px; padding-left: 160px; padding-right: 160px">
            ...
            <table>
                ...
                <tr>
                    <td style="text-align: justify">
                        Dengan ini disampaikan bahwa pengajuan magang/PKL Mahasiswa tersebut belum dapat kami fasilitasi.
                    </td>
                </tr>
                <tr>
                    <td>&emsp;</td>
                ...
                <tr style="text-align: justify">
                    <td>Terimakasih, dan mohon maaf.</td>
                </tr>
                <tr>
                    <td>&emsp;</td>
                </tr>
